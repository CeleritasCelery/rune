...
This project is an experimental Emacs lisp interpreter written in rust. The project is still at a very early phase and explores using rust as an host language. See the [[file:details.org][design doc]] for more details.
** Status
